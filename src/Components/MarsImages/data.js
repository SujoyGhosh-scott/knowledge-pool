export const roverInfo = {
  curiosity: {
    name: "curiosity",
    info: "Curiosity explores Gale Crater and acquires rock, soil, and air samples for onboard analysis. The car-size rover is about as tall as a basketball player and uses a 7 foot-long arm to place tools close to rocks selected for study. It hunts for special rocks that formed in water and/or have signs of organics.",
